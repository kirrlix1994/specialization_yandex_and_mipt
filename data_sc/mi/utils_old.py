...
def prepare(df):
	...
	# remove transactions features which 0.75 quantile == 0:
...
#
    ...
    list_to_drop = [
        ...
        'BIRTH_DATE',
        'LAST_CARD_STATUS_DT', #  LAST_CARD_STATUS_TIME
...
def print_metrics(y_real, y_proba, thr, at):
    ...
    if abs(np.mean(y_pred) - thr) > 0.02:
        warnings.warn('Not many variants for threshold')
...
#         'metric': ['ROC AUC', 'Av Precision', 'logloss', 'Accuracy', 'Precision',
